<%@ page language="java" import="java.util.*" import="com.hsp.forms.*" pageEncoding="utf-8" %>
...
<ul>
<li id="reg_log" >Welcome! <%=((UserForm)request.getAttribute("userform")).getUseremail()+((UserForm)request.getAttribute("userform")).getRegistermail() %>&nbsp;</li>
